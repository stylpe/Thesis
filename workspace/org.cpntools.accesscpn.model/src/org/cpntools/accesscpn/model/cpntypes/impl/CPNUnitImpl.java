 ...
 * <ul>
 *   <li>{@link org.cpntools.accesscpn.model.cpntypes.impl.CPNUnitImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CPNUnitImpl extends CPNTypeImpl implements CPNUnit {
	...
	protected EClass eStaticClass() {
		return CpntypesPackageImpl.Literals.CPN_UNIT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntypesPackageImpl.CPN_UNIT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CpntypesPackageImpl.CPN_UNIT__ID:
				return getId();
		}

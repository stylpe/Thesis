 ...
 * <ul>
 *   <li>{@link org.cpntools.accesscpn.model.impl.PlaceImpl#getReferences <em>References</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends PlaceNodeImpl implements Place {
	 ...
	 * @ordered
	 */
	protected EList<RefPlace> references;
	...
	protected EClass eStaticClass() {
		return ModelPackageImpl.Literals.PLACE;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackageImpl.PLACE__REFERENCES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackageImpl.PLACE__REFERENCES:
				getReferences().clear();
				getReferences().addAll((Collection<? extends RefPlace>)newValue);
				return;
		}

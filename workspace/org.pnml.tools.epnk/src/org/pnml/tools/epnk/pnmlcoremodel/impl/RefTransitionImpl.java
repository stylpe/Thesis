 ...
 * <ul>
 *   <li>{@link org.pnml.tools.epnk.pnmlcoremodel.impl.RefTransitionImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefTransitionImpl extends TransitionNodeImpl implements RefTransition {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.REF_TRANSITION;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PnmlcoremodelPackage.REF_TRANSITION__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(TransitionNode newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.REF_TRANSITION__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PnmlcoremodelPackage.REF_TRANSITION__REF:

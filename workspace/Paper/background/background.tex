...
\subsection{Overview}
	...
	\fig[0.4]{Overview.eps}{Overview module of the WebSocket CPN model}{overview}
...
\subsection{Client Application}
	...
	of a CPN model.
	\fig[0.38]{ClientApplication.eps}{The Client Application Module}{client_app}
	...
	\subsubsection{Control Flow}
		...
		After the \nodename{Convert to URL} transition has occurred (see \figref{client_app}),
...
\subsection{The Client WebSocket Module}\label{sec:client_ws}
	...
	\fig[0.43]{ClientWebSocket.eps}{The Client WebSocket Module}{client_wslib}
	...
	\subsubsection{Process Response Module}
		...
		\fig[0.4]{ProcessResponse.eps}{Process Response submodule}{process_response}
	...
	\subsubsection{Unwrap and Receive Module}
		...
		\figrot[0.38]{UnwrapAndReceive.eps}{Unwrap And Receive
		...
		\begin{itemize}
			\item The first one is modelled by the \nodename{Receive} transition, and
		...
		\paragraph{Defragmenting fragmented frames.}
			...
			\figref{defrag} shows this module. Any frame that is part of a fragmented
...
\subsection{Connection Module}
	...
	\fig[0.45]{Connection.eps}{The Connection module}{connection}
	
	\figref{connection} shows the connection layer as modelled by the
...
\subsection{The Server WebSocket Module}
	...
	\fig[0.43]{ServerWebSocket.eps}{The Server WebSocket Module}{server_wslib}
	...
	\subsubsection{Send Connection Response Module}
		...
		\fig[0.4]{ConnectionResponse.eps}{Send Connection Response}{connection_res}
...
\subsection{Server Application}
	...
	\fig[0.37]{ServerApplication.eps}{The Server Application Module}{server_app}

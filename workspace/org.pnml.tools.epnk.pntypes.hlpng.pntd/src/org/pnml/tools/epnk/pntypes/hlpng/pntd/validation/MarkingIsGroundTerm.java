...
/**
 * This is a constraint saying that the marking must be a ground term.
 *  
 * @author eki
 * @generated NOT
 */
public class MarkingIsGroundTerm extends AbstractModelConstraint {
	...
	public IStatus validate(IValidationContext ctx) {
		...
		if (object instanceof Place) {
			...
			if (marking != null) {
				...
				if (term != null && ! ValidationHelperMethods.isGround(term)) {

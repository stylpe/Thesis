...
/**
 * This is a constraint says that a HLPNG of type dot net does not
 * have any declarations.
 *  
 * @author eki
 * @generated NOT
 */
public class DotNetTypeHasNoDeclarations extends AbstractModelConstraint {
	...
	public IStatus validate(IValidationContext ctx) {
		...
		if (object instanceof Declaration) {
			Declaration decl = (Declaration) object;
			return ctx.createFailureStatus(new java.lang.Object[] {object, decl.getText()});
		}

...
/**
 * This is the item provider adapter for a {@link org.cpntools.pragma.epnk.pnktypes.pragmacpndefinition.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
	extends org.cpntools.pragma.epnk.pnktypes.cpndefinition.provider.PageItemProvider
	implements
		...
		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 PragmacpndefinitionFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 PragmacpndefinitionFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(PnmlcoremodelPackage.Literals.PAGE__OBJECT,
				 PragmacpndefinitionFactory.eINSTANCE.createArc()));

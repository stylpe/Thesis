		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PragmaCPN_LoadedPragmaSets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PragmaCPN_LoadedPragmaSets_feature", "_UI_PragmaCPN_type"),
				 PragmacpndefinitionPackage.Literals.PRAGMA_CPN__LOADED_PRAGMA_SETS,
				 true,
				 false,
				 false,

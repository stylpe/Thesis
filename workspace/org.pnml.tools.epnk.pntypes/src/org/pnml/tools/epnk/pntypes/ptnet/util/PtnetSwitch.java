	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PtnetPackage.PT_MARKING: {
				...
				if (result == null) result = caseLabel(ptMarking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PtnetPackage.PT_ARC_ANNOTATION: {
				...
				if (result == null) result = caseLabel(ptArcAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PtnetPackage.PT_NET: {
				PTNet ptNet = (PTNet)theEObject;
				T result = casePTNet(ptNet);
				if (result == null) result = casePetriNetType(ptNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
